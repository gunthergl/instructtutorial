...
mono_markers <- c(
	'CD14','CD16','HLADR','CD10','CD69',
	'CD11c','CD123',
	'CCR6','CRTH2','CXCR3','CXCR5',
	
	'CD38',	'Ki67','CD62L','CD25','CD226',
	'CD95','ICOS','PD1','Lag3','TIGIT',
	'CD96','CD56','KLRG1','KLRF1','KLRB1',
	'CD27', 'CD28','CD45RO','CD137'
	)
...
rownames(annotation_rows) <- mono_markers

data_heatmap[, mono_markers] %>%
    ...
    pheatmap(
        ...
        breaks = seq(-4.5, 4.5, length.out = 100),
...
selected_ids <- data_mono %>%
    ...
    dplyr::mutate(n_samples = 1:dplyr::n()) %>%
    # Select the id where the Days.post.symptom.onset is the minimum
    dplyr::mutate(select_id = ifelse(n_samples == 1, TRUE,
