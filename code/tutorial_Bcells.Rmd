---
title: "INsTRuCT Tutorial 2022 (B cells)"
...
sel_markers_Bcells <- c(
    "IgD", "IgM", "CD10", "CD21", "CD27", "CD38", "CXCR3", "CXCR5", "CCR6", "CRTH2", "HLADR",
    "CD69", "Ki67", "CD11c", "CD25", "CD95", "CD137", "CD226", "ICOS", "PD1", "Lag3", "TIGIT",
    "CD96", "CD123", "KLRG1", "KLRF1", "CD16", "CD28", "CD62L", "CD45RO", "CD56", "CD34"
)
```
...
data_Bcells <- transformed_scaled_data %>%
...
Recommendation: Subsample Cells for visualization, using `sample_n()`, or `sample_frac`. 
