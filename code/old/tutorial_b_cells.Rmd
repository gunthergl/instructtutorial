...
```{r columnBcells}
data_norm_sub <- data_norm_sub %>% mutate(Bcell = ifelse(CD19>sinh(4) & CD19<sinh(10) & CD45>sinh(3) & CD45<sinh(8) & CD3<sinh(3.6) & CD15<sinh(3), TRUE, FALSE))
...
* Compute the UMAPs for each T cell compartment across all samples (acute and convalescent), and using all markers, except the channels we used for gating, and also excluding CD45RO, CRTH2, and CD14.
